            ...
            <li class="media">
                ...
                <div class="media-body">
                    ...
                    <small class="media-body meta text-secondary">
                        ...
                        <span class="timeago" title="最后活跃于：{{ $topic->updated_at }}">{{ ends_with(Request::getQueryString(), "recent") ? $topic->created_at->diffForHumans() : $topic->updated_at->diffForHumans() }}</span>
                    </small>
